...
DESCRIPTION: You will be shown a list of five historical events and five options for the order in which they took place. You have to guess the option corresponding to the correct chronological order of these events.  
...
Multiple choice Option Selection - 1 of the options is the correct answer and for the other 3, the set {1,2,3,4,5} is shuffled until 4 different incorrect sequences are generated. Distinctness to the correct answer is always ensured.
