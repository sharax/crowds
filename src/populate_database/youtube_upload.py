...
def youtube_upload(arguments,title):
    ...
    parser.add_option('-m', '--email', dest='email', type="string",
        help='Authentication email or Youtube username',default = 'wcrowds@gmail.com')
    parser.add_option('-p', '--password', dest='password', type="string",
        help='Authentication password',default = 'Woc12345678')
    parser.add_option('-t', '--title', dest='title', type="string",
        help='Video(s) title',default=title)
    parser.add_option('-c', '--category', dest='category', type="string",
        help='Video(s) category',default='Education')
...
if __name__ == '__main__':
    sys.exit(catch_exceptions(EXIT_CODES, upload_youtube, sys.argv[1:]))
