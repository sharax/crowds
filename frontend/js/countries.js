...
function getCountryKeyArr() {
    var keyArr = {};
    var currLetter = "a";
    keyArr[currLetter] = [];
    for(var i = 0; i < countries.length; i++) {
        var country = countries[i];
        if(country.toLowerCase()[0] !== currLetter) {
            currLetter = country.toLowerCase()[0];
            keyArr[currLetter] = [];
        }
        keyArr[currLetter].push(country);
    }
    return keyArr;
}

var countryKeyArr = getCountryKeyArr();
